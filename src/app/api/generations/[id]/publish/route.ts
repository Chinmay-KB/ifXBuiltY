...
export async function POST(_request: Request, context: RouteContext) {
  ...
  // New generations already have CDN variants (built at generation time). This is
  // a safety net for legacy drafts: generate any missing variants via the service
  // client (storage writes bypass RLS), so published rows are always CDN-servable.
  try {
    await ensureGenerationVariants({
