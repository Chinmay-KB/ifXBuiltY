...
const variantClass: Record<ButtonVariant, string> = {
  chrome:
    "border-2 border-ink bg-chrome text-ink shadow-none hover:brightness-[0.98] active:brightness-95",
  ink: "border-2 border-transparent bg-ink text-white hover:bg-ink/90 active:bg-ink/80",
  outline:
    "border border-line-strong bg-canvas text-ink hover:bg-panel active:bg-panel/80",
  ghost: "border-0 bg-transparent text-muted hover:text-ink hover:bg-panel/60",
  pillSolid:
    "rounded-full border-0 bg-ink px-3.5 py-2 text-[13px] font-extrabold leading-[18px] text-white hover:bg-ink/90",
  pillOutline:
    "rounded-full border border-line-strong bg-canvas px-3.5 py-2 text-[13px] font-extrabold leading-[18px] text-ink hover:bg-panel",
};

const sizeClass: Record<ButtonSize, string> = {
  sm: "rounded-lg px-3 py-2 text-[13px] font-semibold leading-[18px]",
  md: "rounded-lg px-3.5 py-2.5 text-sm font-semibold leading-5",
  lg: "rounded-lg px-4 py-3.5 text-base font-semibold leading-snug",
};
